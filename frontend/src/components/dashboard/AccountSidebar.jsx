  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 py-4">
        ...
        <Link
          to="/account/take-assessment"
          className="flex items-center gap-3 px-4 py-3 transition-all"
          style={{
            backgroundColor: location.pathname === '/account/take-assessment' ? '#21252C' : 'transparent',
            borderLeft: location.pathname === '/account/take-assessment' ? '3px solid #4ADE80' : '3px solid transparent',
            textDecoration: 'none'
          }}
        >
          <svg className="w-5 h-5" fill="none" stroke="white" viewBox="0 0 24 24">
        ...
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 transition-all"
          style={{
            backgroundColor: location.pathname === '/account/history' ? '#21252C' : 'transparent',
            borderLeft: location.pathname === '/account/history' ? '3px solid #4ADE80' : '3px solid transparent',
            textDecoration: 'none'
          }}
        >
          <svg className="w-5 h-5" fill="none" stroke="white" viewBox="0 0 24 24">
