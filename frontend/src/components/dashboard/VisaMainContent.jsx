...
function MailingChecklist({
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:gap-8">
      {/* Left column: Checklist items (narrower) */}
      <div className="lg:w-[40%] lg:flex-shrink-0 space-y-4">
        {/* Progress summary */}
        <div
      ...
      {/* Right column: Video, fee info, addresses (sticky on desktop, wider) */}
      <div className="mt-6 lg:mt-0 lg:flex-1">
        <div className="lg:sticky lg:top-6 space-y-4">
          ...
          {filingFee && (
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm" style={{ fontFamily: 'Soehne, sans-serif', color: '#991B1B' }}>
                    {filingFee} filing fee
                  </p>
                  <p className="text-xs mt-1" style={{ fontFamily: 'Soehne, sans-serif', color: '#991B1B' }}>
                    G-1450 or G-1650 only
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {mailingAddresses.usps && (
                  <div>
                    ...
                    <p className="text-xs whitespace-pre-line" style={{ fontFamily: 'Soehne, sans-serif', color: '#1E1F1C' }}>
          ...
          <div
            ...
            style={{ backgroundColor: '#1E3A5F' }}
          >
            <p className="font-semibold text-sm" style={{ fontFamily: 'Soehne, sans-serif', color: 'white' }}>
              Before you mail
            </p>
            <ul className="mt-2 text-xs space-y-1" style={{ fontFamily: 'Soehne, sans-serif', color: 'rgba(255,255,255,0.9)' }}>
              <li>• Make copies of EVERYTHING</li>
              <li>• Use USPS Priority Mail with tracking</li>
              <li>• Keep your tracking number</li>
              <li>• Do NOT send originals</li>
            </ul>
          </div>
        </div>
      </div>
...
export default function VisaMainContent({
  ...
  if (phaseConfig) {
    ...
    const hasRightColumn = phaseConfig.video || phaseConfig.tips;
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Two-column layout: Documents left, Video/Tips right */}
        <div className={`flex flex-col ${hasRightColumn ? 'lg:flex-row lg:gap-8' : ''}`}>
          {/* Left column: Documents (narrower) */}
          <div className={`${hasRightColumn ? 'lg:w-[40%] lg:flex-shrink-0' : 'flex-1'}`}>
            {/* Phase progress */}
          ...
          {/* Right column: Video and Tips (sticky on desktop, wider) */}
          {hasRightColumn && (
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="lg:sticky lg:top-6 space-y-4">
                {/* Phase video guide */}
