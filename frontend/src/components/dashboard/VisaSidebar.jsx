/**
 * VisaSidebar Component
 * Generic phase-based navigation for visa dashboards.
 * Accepts timeline and config as props instead of importing K-1 specific data.
 */
...
export default function VisaSidebar({
  ...
  // Build phase config from timeline prop
